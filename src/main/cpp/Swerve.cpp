 ...
 */
double SwerveModule::GetMagEncoderReading()
{
 ...
 */
void SwerveDrive::DriveToPose(Pose2d target, double elapsedTime)
{
 ...
 * @param elapsedTime time since function last called
 */
bool SwerveDrive::StrafeToPole(double offset, double elapsedTime)
{
