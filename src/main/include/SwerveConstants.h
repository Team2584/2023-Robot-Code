...
#define S_TRANSLATION_KP 1.27
#define S_TRANSLATION_KI 0
#define S_TRANSLATION_KD 0
#define S_TRANSLATION_KI_MAX 0.1
#define S_TRANSLATION_MAX_SPEED 0.2
#define S_TRANSLATION_MAX_ACCEL 0.7
#define S_SPIN_KP 0.56
#define S_SPIN_KI 0
#define S_SPIN_KI_MAX 0.1
#define S_SPIN_KD 0
#define S_SPIN_MAX_SPEED 0.2_rad_per_s
#define S_SPIN_MAX_ACCEL 0.6_rad_per_s_sq
