...
#define O_TRANSLATION_KP 0.7    //old is 1.45
#define O_TRANSLATION_KI 0
#define O_TRANSLATION_KI_MAX 0.1
#define O_TRANSLATION_MAX_SPEED 0.15
#define O_TRANSLATION_MAX_ACCEL 0.5
#define O_SPIN_KP 0.3  //old is 0.7
#define O_SPIN_KI 0
#define O_SPIN_KI_MAX 0.1
#define O_SPIN_MAX_SPEED 0.2
#define O_SPIN_MAX_ACCEL 0.7  
#define O_ALLOWABLE_ERROR_TRANSLATION 0.03
#define O_ALLOWABLE_ERROR_ROTATION 0.05

//PID VALUES FOR DRIVE TO POSE VISION
#define V_TRANSLATION_KP 0.7    //old is 1.45
#define V_TRANSLATION_KI 0
#define V_TRANSLATION_KI_MAX 0.1
#define V_TRANSLATION_MAX_SPEED 0.15
#define V_TRANSLATION_MAX_ACCEL 0.5
#define V_SPIN_KP 0.3  //old is 0.7
#define V_SPIN_KI 0
#define V_SPIN_KI_MAX 0.1
#define V_SPIN_MAX_SPEED 0.2
#define V_SPIN_MAX_ACCEL 0.7  
#define V_ALLOWABLE_ERROR_TRANSLATION 0.03
#define V_ALLOWABLE_ERROR_ROTATION 0.05
